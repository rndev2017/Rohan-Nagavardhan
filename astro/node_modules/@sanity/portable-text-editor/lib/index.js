...
var jsxRuntime = require("react/jsx-runtime"), isEqual = require("lodash/isEqual.js"), noop = require("lodash/noop.js"), react = require("react"), slate = require("slate"), slateReact = require("slate-react"), debug$l = require("debug"), types = require("@sanity/types"), content = require("@sanity/util/content"), styledComponents = require("styled-components"), uniq = require("lodash/uniq.js"), rxjs = require("rxjs"), schema = require("@sanity/schema"), get = require("lodash/get.js"), isUndefined = require("lodash/isUndefined.js"), omitBy = require("lodash/omitBy.js"), isObject = require("lodash/isObject.js"), isString = require("lodash/isString.js"), findIndex = require("lodash/findIndex.js"), clone = require("lodash/clone.js"), omit = require("lodash/omit.js"), flatten$1 = require("lodash/flatten.js"), isHotkeyEsm = require("is-hotkey-esm"), blockTools = require("@sanity/block-tools"), isPlainObject = require("lodash/isPlainObject.js"), throttle = require("lodash/throttle.js"), debounce = require("lodash/debounce.js");
  ...
  return function(editor) {
    return portableTextEditor.setEditable({
      ...
      insertChild: (type, value) => {
        ...
        return isSpanNode && focusNode._type !== types$1.span.name && (debug$h("Inserting span child next to inline object child, moving selection + 1"), editor.move({ distance: 1, unit: "character" })), slate.Transforms.insertNodes(editor, child, {
          select: !0,
          at: editor.selection
      ...
      addAnnotation: (type, value) => {
        ...
        if (selection) {
          ...
          if (slate.Element.isElement(block) && block._type === types$1.block.name) {
        ...
        if (debug$h("Removing annotation", type), selection) {
          ...
          slate.Editor.withoutNormalizing(editor, () => {
            if (selection && slate.Range.isExpanded(selection)) {
              ...
              }), normalizeMarkDefs(editor, types$1);
            }
          }), slate.Editor.normalize(editor), editor.onChange();
        }
      },
    ...
    return editor.apply = (op) => {
      if (op.type === "remove_node") {
        ...
        if (op.path[0] === 0 && slate.Editor.isVoid(editor, node)) {
          ...
          editor.children[nextPath[0]] || (debug$d("Adding placeholder block"), slate.Editor.insertNode(editor, editor.pteCreateEmptyBlock()));
        }
      }
      apply2(op);
    }, editor;
...
function validateValue(value, types$1, keyGenerator) {
  ...
  return value === void 0 ? { valid: !0, resolution: null, value } : !Array.isArray(value) || value.length === 0 ? {
    ...
    if (blk._type === types$1.block.name) {
      ...
      textBlock.children.some((child, cIndex) => isPlainObject__default.default(child) ? child._type ? validChildTypes.includes(child._type) ? child._type === types$1.span.name && typeof child.text != "string" ? (resolution = {
        patches: [
