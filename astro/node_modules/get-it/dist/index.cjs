...
var defaultOptionsValidator = require("./_chunks-cjs/defaultOptionsValidator.cjs"), decompressResponse = require("decompress-response"), follow = require("follow-redirects"), http = require("http"), https = require("https"), progressStream = require("progress-stream"), qs = require("querystring"), stream = require("stream"), url = require("url"), tunnel = require("tunnel-agent");
...
const isStream = (stream2) => stream2 !== null && typeof stream2 == "object" && typeof stream2.pipe == "function", adapter = "node", reduceResponse = (res, reqUrl, method, body) => ({
  body,
  url: reqUrl,
  method,
  headers: res.headers,
