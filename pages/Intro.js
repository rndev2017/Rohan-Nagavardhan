    ...
    return (
        <header id={styles.intro} className="text-gray-900 h-screen flex flex-col justify-around font-light">
            <div id="greeting" className="flex flex-row">
                <p className="text-2xl md:text-5xl pr-5">Hey!</p>
                <img className="h-7 w-7 lg:h-12 lg:w-12 hover:animate-wave" src="./images/wave.png"/>
            </div>
            <div className="max-w-2xl lg:max-w-3xl ">
                <p className="text-2xl tracking-widest leading-relaxed lg:text-5xl">
                    I'm 
