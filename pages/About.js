...
export default function About() {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-gray-600 md:max-w-2xl">
            ...
            <div className="text-sm md:text-xl p-5">
                <div className="flex flex-row mt-3 font-light">
                    <p>I'm currently a full-stack software engineer at 
                    <a href="https://www.thinkwander.com/landing" target="_blank"><span className="font-bold"> Wander </span></a> 
                    building a platform for users to share and discuss intellectual content with their network. 
                    I am also studying Computer Science at the 
                    <a href="https://umich.edu/" target="_blank" className="font-bold"> University of Michigan </a> 
                    and potentially considering a minor in Astronomy and Astrophysics. Before college,
                    I was working on <a className="font-bold" href={researchLink} target="_blank"> astrophysics research </a> 
                ...
                <div className="flex flex-row mt-5 justify-center  font-light">
                    <p><span className="font-bold">When I'm not sitting in front of my computer</span>, 
