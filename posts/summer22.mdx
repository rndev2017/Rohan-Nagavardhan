...
<p style={{fontSize: '0.8rem'}}className="text-neutral-400 italic">* Credit: Google Search documentation</p>
...
<p style={{fontSize: '0.8rem'}}className="text-neutral-400 italic">* Data provided by Netlify Analytics</p>
...
<p style={{fontSize: '0.8rem'}}className="text-neutral-400 italic">* Credit: Yuri Fedorov</p>
